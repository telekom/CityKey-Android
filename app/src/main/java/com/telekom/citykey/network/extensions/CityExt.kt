...
val City.cityColorInt: Int get() = tryParsingColor(cityColor)

val City.location: LatLng get() = LatLng(latitude, longitude)

fun City.toHomeData(): HomeData {
...
//            if (city.cityConfig.showHomeDiscounts) viewTypes.add(HomeViewTypes.VIEW_TYPE_DISCOUNTS)
    ...
    return HomeData(
        this.cityName,
        this.municipalCoat,
        tryParsingColor(this.cityColor),
        viewTypes
    )
}
