...
package com.telekom.citykey.view.widget.waste_calendar.widget_2x1
...
import com.telekom.citykey.view.widget.waste_calendar.small_widget.SmallWasteCalendarWidgetRemoteViewService
import org.koin.core.component.KoinComponent
import org.koin.core.component.inject
import java.util.*


class WasteCalendarWidget2x1 : AppWidgetProvider(), KoinComponent {
    companion object {
    ...
    override fun onReceive(context: Context?, intent: Intent) {
        when (intent.action) {
            ...
            Intent.ACTION_DATE_CHANGED -> {
                ...
                val ids =
                    manager.getAppWidgetIds(context?.let { ComponentName(it, WasteCalendarWidget2x1::class.java) })
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            views.setViewVisibility(R.id.widget2x1GradientView, View.VISIBLE)
    ...
    override fun onEnabled(context: Context) {
        ...
        context.scheduleMidnightUpdateForWidget<WasteCalendarWidget2x1>(
            WasteCalendarWidgetConstants.ACTION_WASTE_CALENDAR_WIDGET_SCHEDULED_UPDATE
        )
    }
    ...
    override fun onDisabled(context: Context) {
        ...
        context.removeMidnightUpdateForWidget<WasteCalendarWidget2x1>(
            WasteCalendarWidgetConstants.ACTION_WASTE_CALENDAR_WIDGET_SCHEDULED_UPDATE
        )
    }
}
