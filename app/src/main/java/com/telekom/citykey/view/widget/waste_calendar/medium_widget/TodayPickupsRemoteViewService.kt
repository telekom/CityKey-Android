...
class TodayPickupsRemoteViewService : RemoteViewsService() {
    ...
    inner class WasteMediumItemViewsFactory(
        ...
        override fun getCount(): Int = pickupData.today.distinct().size
        ...
        override fun getViewAt(position: Int): RemoteViews {
            ...
            populateWastePickupData(view, pickupData.today[position])
