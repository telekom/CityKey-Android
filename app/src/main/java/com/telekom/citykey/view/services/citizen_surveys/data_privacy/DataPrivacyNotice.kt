...
class DataPrivacyNotice(
    ...
    private fun handleWindowInsets() {
        ...
        binding.dataPrivacyBody.applySafeAllInsetsWithSides(left = true, right = true)
        binding.btnDataPrivacy.applySafeAllInsetsWithSides(left = true, right = true, bottom = true)
    }
}
