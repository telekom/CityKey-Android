...
class SurveysOverview : MainFragment(R.layout.survey_overview_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textEmptyState.apply {
            text = if (viewModel.isPreview()) {
                context.getString(R.string.cs_002_preview_error_no_surveys)
            } else {
                context.getString(R.string.cs_002_error_no_surveys)
            }
        }
        subscribeUi()
    ...
    override fun handleWindowInsets() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(binding.root) { _, insets ->
            ...
            binding.toolbarSurveys.updatePadding(
        ...
        binding.swipeRefreshLayout.applySafeAllInsetsWithSides(left = true, right = true, bottom = true)
    }
