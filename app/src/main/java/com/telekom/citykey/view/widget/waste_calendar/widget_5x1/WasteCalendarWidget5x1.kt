package com.telekom.citykey.view.widget.waste_calendar.widget_5x1
...
import com.telekom.citykey.view.widget.waste_calendar.medium_widget.DATPickupsRemoteViewService
import com.telekom.citykey.view.widget.waste_calendar.medium_widget.TodayPickupsRemoteViewService
import com.telekom.citykey.view.widget.waste_calendar.medium_widget.TomorrowPickupsRemoteViewService
import org.koin.core.component.KoinComponent
import org.koin.core.component.inject
import java.text.SimpleDateFormat
import java.util.*

class WasteCalendarWidget5x1 : AppWidgetProvider(), KoinComponent {
    companion object {
    ...
    override fun onReceive(context: Context?, intent: Intent) {
        when (intent.action) {
            ...
            Intent.ACTION_DATE_CHANGED -> {
                ...
                val ids =
                    manager.getAppWidgetIds(context?.let { ComponentName(it, WasteCalendarWidget5x1::class.java) })
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            views.setViewVisibility(R.id.today5x1Gradient, View.VISIBLE)
            views.setViewVisibility(R.id.tomorrow5x1Gradient, View.VISIBLE)
            views.setViewVisibility(R.id.dAT5x1Gradient, View.VISIBLE)
    ...
    override fun onEnabled(context: Context) {
        ...
        context.scheduleMidnightUpdateForWidget<WasteCalendarWidget5x1>(
            WasteCalendarWidgetConstants.ACTION_WASTE_CALENDAR_WIDGET_SCHEDULED_UPDATE
        )
    }
    ...
    override fun onDisabled(context: Context) {
        ...
        context.removeMidnightUpdateForWidget<WasteCalendarWidget5x1>(
            WasteCalendarWidgetConstants.ACTION_WASTE_CALENDAR_WIDGET_SCHEDULED_UPDATE
        )
    }
}
